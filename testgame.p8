...
__lua__
 ...
 itm_name=split("twig,stick,club,cane,staff,heavy log,shawl,cloak,robe,cape,gown,regalia,food 1,food 2,food 3,food 4,food 5,food 6,pebble,rock,stone,boulder")
	...
	mob_name=split("player,slime,rat,goblin,beast,giant moth,specter,minotaur,dragon")
...
function placedoors()
 for d in all(doors) do
  local dx,dy=d.x,d.y
  if mget(dx,dy)==1 or mget(dx,dy)==62 and isdoor(dx,dy) and not bytile(dx,dy,13) then
   mset(dx,dy,13)
  end
 end
end
...
function decorooms()
 for r in all(rooms) do
  ...
  function vase(r,tx,ty,x,y)
   if not bytile(tx,ty,13) and mget(tx,ty)==1 then
    local tarr=ints("1,1,7,7,8")
  ...
  local funcs={plant,shroom,vase}
  fn=getrnd(funcs)

  visit(function(x,y)
   if iswalkable(x,y,"checkmobs") then
...
function decobase(r,tx,ty,x,y)
 if rnd()>0.5 and y>0 then
  mset(tx,ty,rndint(68,70))
 end
end

function decotorch(r,tx,ty,x,y)
 if y%2==0 or bytile(tx,ty,13) or mget(tx,ty)!=1 then
  return false
 end
 if x==0 then
  mset(tx,ty,64)
...
function placechest(r,rare)
 local x,y
 repeat
  x,y=r.x+rndint(0,r.w-2),
   r.y+rndint(0,r.h-2)
 until mget(x,y)==1 and not bytile(x,y,13)
...

...
000b3000300300505003b000000b30000503b00000033000000330000003b00000033000000b3030000bb00000033000003330000003b0000305003000033000
...

...

...

...

...

__label__
...

